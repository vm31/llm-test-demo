...
export const utils = {
  ...
  clickByRole: async (
    page: Page,
    role: 'button' | 'link' | 'checkbox' | 'alert' | 'dialog' | 'alertdialog' | 'application' | 'article' | 'banner' | 'blockquote' | 'caption' | 'cell' | 'code' | 'columnheader' | 'img' | 'menu' | 'menubar' | 'navigation' | 'note' | 'row' | 'rowgroup' | 'list' | 'listitem' | 'main' | 'meter' | 'progressbar' | 'radio' | 'radiogroup' | 'search' | 'status' | 'tab' | 'tabpanel' | 'textbox' | 'tree' | 'treeitem',
    name: string
  ): Promise<void> => {
